...
def load_dataset_NRE_TRE():
    ...
    val_x_mini_path = os.path.join(dataset_path,'val_x_joint_mini_for_Figure_2.npy')
    val_thetas_mini_path = os.path.join(dataset_path, 'val_thetas_joint_mini_for_Figure_2.npy')
...
if __name__ == '__main__':
    ...
    #plt.show()
    plt.savefig(os.path.join(os.getcwd(), 'src' , 'visualisations', f'Figure_2.pdf'),
                #f'Figure_2.pdf',
